...
(4, 'Child', '2024-08-06 18:43:10', '2024-08-06 18:43:10'),
(5, 'Coach', '2024-08-06 18:43:10', '2024-08-06 18:43:10'),
(6, 'Manager', '2024-08-06 18:43:10', '2024-08-06 18:43:10');
...
--
-- Table structure for table `session_properties`
--

CREATE TABLE `session_properties` (
  `uid` int(11) NOT NULL,
  `session_id` int(11) NOT NULL,
  `prop_length` int(11) DEFAULT NULL,
  `prop_style` int(11) DEFAULT NULL,
  `prop_date` date DEFAULT NULL,
  `Active` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `session_properties`
--

INSERT INTO `session_properties` (`uid`, `session_id`, `prop_length`, `prop_style`, `prop_date`, `Active`) VALUES
(1, 1, 2, NULL, NULL, 1),
(2, 1, 4, NULL, NULL, 1),
(3, 1, 5, NULL, NULL, 1),
(4, 1, 6, NULL, NULL, 1),
...
CREATE TABLE `students` (
  ...
  `NameWithInitials` text DEFAULT NULL,
  `Active` tinyint(1) NOT NULL,
...
INSERT INTO `students` (`StudentID`, `AdmissionNumber`, `FirstName`, `LastName`, `FullName`, `NameWithInitials`, `Active`, `Approved`, `DOB`, `ParentID`, `createdAt`, `updatedAt`, `Comment`) VALUES
(10001, 'COM-0909', 'Samson', 'Smith Jr', 'Samson Smith Jr', 'S. Smith Jr', 1, 1, '2018-12-31', 14, '2025-05-08 13:15:05', '2025-06-08 07:49:56', ''),
(10002, 'ART-2023', 'Nala', 'The Lion', 'Nala The Lion', 'N. The Lion', 1, 1, '2017-06-15', 15, '2025-05-08 13:15:05', '2025-05-08 18:45:22', ''),
(10003, 'COM-3435', 'Diana', 'Mason', 'Diana Mason', 'D. Mason', 1, 1, '2016-01-01', 14, '2025-05-08 13:15:05', '2025-05-29 15:07:31', ''),
(10004, 'COM-6448', 'Leo', 'James', 'Leo James', 'L. James', 1, 1, '2015-12-31', 15, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10005, 'SCI-2623', 'Maya', 'Johnson', 'Maya Johnson', 'M. Johnson', 1, 1, '2015-01-01', 14, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10006, 'ART-4192', 'Lucas', 'Martin', 'Lucas Martin', 'L. Martin', 1, 1, '2014-01-01', 15, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10007, 'COM-6429', 'Emma', 'Lee', 'Emma Lee', 'E. Lee', 1, 1, '2013-12-31', 19, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10008, 'SCI-2230', 'Noah', 'Clark', 'Noah Clark', 'N. Clark', 1, 1, '2013-01-01', 14, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10009, 'ART-8957', 'Olivia', 'Wright', 'Olivia Wright', 'O. Wright', 1, 1, '2012-01-01', 15, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10010, 'COM-1394', 'Liam', 'Baker', 'Liam Baker', 'L. Baker', 1, 1, '2011-12-31', 19, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10011, 'SCI-9583', 'Sophia', 'Hall', 'Sophia Hall', 'S. Hall', 1, 1, '2011-01-01', 23, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10012, 'ART-5649', 'Aiden', 'Young', 'Aiden Young', 'A. Young', 1, 1, '2010-01-01', 24, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10013, 'COM-8766', 'Isabella', 'King', 'Isabella King', 'I. King', 1, 1, '2009-12-31', 25, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10014, 'SCI-6749', 'Ethan', 'Scott', 'Ethan Scott', 'E. Scott', 1, 1, '2009-01-01', 23, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10015, 'ART-1218', 'Ava', 'Green', 'Ava Green', 'A. Green', 1, 1, '2008-01-01', 24, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10016, 'COM-1040', 'James', 'Adams', 'James Adams', 'J. Adams', 1, 1, '2007-12-31', 25, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10017, 'SCI-1934', 'Charlotte', 'Nelson', 'Charlotte Nelson', 'C. Nelson', 1, 1, '2007-01-01', 23, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10018, 'ART-9056', 'Benjamin', 'Hill', 'Benjamin Hill', 'B. Hill', 1, 1, '2006-01-01', 25, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10019, 'COM-2225', 'Amelia', 'Carter', 'Amelia Carter', 'A. Carter', 1, 1, '2005-12-31', 19, '2025-05-08 18:53:25', '2025-06-08 16:14:44', ''),
(10020, 'SCI-8372', 'Henry', 'Mitchell', 'Henry Mitchell', 'H. Mitchell', 1, 1, '2005-01-01', 25, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10021, 'ART-4221', 'Mia', 'Perez', 'Mia Perez', 'M. Perez', 1, 1, '2004-12-31', 23, '2025-05-08 18:53:25', '2025-06-01 09:33:23', ''),
(10022, 'COM-8567', 'Alexander', 'Roberts', 'Alexander Roberts', 'A. Roberts', 1, 1, '2015-12-29', 19, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10023, 'SCI-5159', 'Ella', 'Turner', 'Ella Turner', 'E. Turner', 1, 1, '2016-03-03', 24, '2025-05-08 18:53:25', '2025-05-09 00:23:25', ''),
(10024, 'COM/0652', 'Samson', 'Romanawski', 'Samson Romanawski', 'S. Romanawski', 1, 1, '2013-06-14', 24, '2025-05-29 13:55:27', '2025-05-29 14:26:22', ''),
(10025, 'ART/0957', 'Samson Jr', 'Romana', 'Samson Jr Romana', 'S. Jr Romana', 1, 1, '2008-02-29', 25, '2025-05-29 14:47:54', '2025-05-29 15:15:11', '');
...
--
-- Indexes for table `session_properties`
--
ALTER TABLE `session_properties`
  ADD PRIMARY KEY (`uid`),
  ADD KEY `session_properties_ibfk_1` (`session_id`),
  ADD KEY `session_properties_ibfk_2` (`prop_length`),
  ADD KEY `session_properties_ibfk_3` (`prop_style`);
...
--
-- AUTO_INCREMENT for table `session_properties`
--
ALTER TABLE `session_properties`
...
--
-- Constraints for table `session_properties`
--
ALTER TABLE `session_properties`
  ADD CONSTRAINT `session_properties_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `session_properties_ibfk_2` FOREIGN KEY (`prop_length`) REFERENCES `distance` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `session_properties_ibfk_3` FOREIGN KEY (`prop_style`) REFERENCES `event` (`EventID`) ON DELETE SET NULL ON UPDATE CASCADE;
